...
corrupted_pixels = cp.array(corrupted_pixels)
...
ax3.imshow(cp.asnumpy(mask), cmap='gray')
ax3.set_axis_off()
...
mask1 = cp.zeros_like(image, dtype=bool)
mask2 = cp.zeros_like(image, dtype=bool)
mask1[rr1, cc1] = True
mask2[rr2, cc2] = True
