...
ax[1].imshow(cp.asnumpy(filled), cmap='gray')
ax[1].set_title('after filling holes')
ax[1].axis('off')

ax[2].imshow(cp.asnumpy(image-filled), cmap='gray')
ax[2].set_title('holes')
ax[2].axis('off')

ax[3].imshow(cp.asnumpy(image-rec), cmap='gray')
