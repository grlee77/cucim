...
ax[0].imshow(cp.asnumpy(astro))
ax[0].set_title('Original Data')

ax[1].imshow(cp.asnumpy(astro_noisy))
ax[1].set_title('Noisy data')

ax[2].imshow(cp.asnumpy(deconvolved_RL),
             vmin=float(astro_noisy.min()), vmax=float(astro_noisy.max()))
