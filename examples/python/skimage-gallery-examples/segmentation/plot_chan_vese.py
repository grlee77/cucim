...
ax[1].imshow(cp.asnumpy(labels), cmap="gray")
ax[1].set_axis_off()
title = f'Chan-Vese segmentation - {len(energy)} iterations'
ax[1].set_title(title, fontsize=12)

ax[2].imshow(cp.asnumpy(phi), cmap="gray")
ax[2].set_axis_off()
ax[2].set_title("Final Level Set", fontsize=12)

# have to move all device scalars back to the host to plot
