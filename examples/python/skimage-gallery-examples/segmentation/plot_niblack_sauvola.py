...
from cucim.skimage.filters import (threshold_otsu, threshold_niblack,
                                   threshold_sauvola)
...
plt.subplot(2, 2, 1)
plt.imshow(cp.asnumpy(image), cmap=plt.cm.gray)
plt.title('Original')
plt.axis('off')

plt.subplot(2, 2, 2)
plt.title('Global Threshold')
plt.imshow(cp.asnumpy(binary_global), cmap=plt.cm.gray)
plt.axis('off')

plt.subplot(2, 2, 3)
plt.imshow(cp.asnumpy(binary_niblack), cmap=plt.cm.gray)
plt.title('Niblack Threshold')
plt.axis('off')

plt.subplot(2, 2, 4)
plt.imshow(cp.asnumpy(binary_sauvola), cmap=plt.cm.gray)
